...
class TSGMM(TBaseClass):
    ...
    def __init__(self):
        ...
        if not self.LoadSettings():
            self.LogError('Error while loading settings. Check if file settSGMM.ini exists')
    ...
    def ProcessMsg(self, enum, param):
        ...
        # restarting cycle once SOTM finished
            ...
            self.TDF = param # param for this message will poin t to the TDF list generated by SOTM
            self.AnalyzeCycle()
